...
{
	char str[256+MAX_NAME*2], dupl_server[MAX_NAME*2];
	int dns_timr_time;
...
{
	char str0[256+MAX_NAME], str1[256+MAX_NAME],str2[256+MAX_NAME],
	  str3[256+MAX_NAME],str4[256+MAX_NAME];

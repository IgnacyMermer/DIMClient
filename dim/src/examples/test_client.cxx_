...
//		cout << "Current INTVAL : " << servint.getInt() << endl;
		...
		cout << "Getting Services from testServer" << endl;
		n = br.getServerServices("testServer");
		dim_print_date_time_millis();
		cout << "Done - Getting Services from testServer - " << n << endl;
//		while (br.getNextServerService(ptr, ptr1))
//		{
//			cout << ptr << " - " << ptr1 << endl;
//		}
...
//	DimClient::setDnsNode(to_node, port);
	while (1) {
		cout << "Services: " << dbr.getServerServices("testServer", 5) << endl;
		n = 0;
		while (dbr.getNextServerService(service, format))
		{
			n++;
//			cout << n << endl;
//			usleep(10);
